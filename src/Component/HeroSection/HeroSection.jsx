...
export const HeroSection = () => {
  return (
    <div className="relative">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex justify-between max-w-[1200px] w-full">
        <div className="flex flex-col items-center">
          <h3 className="text-[60px] font-bold text-white leading-[60px]">We want to</h3>
        ...
        <div className="relative z-0 border-[3px] border-[rgba(244,0,0,0.44)] max-w-[450px] w-full rounded-2xl">
